                            ...
                            <div class="featured-box featured-box-primary">
                                <div class="box-content">
                                    <span class="icon-featured icon-featured-lg">
                                        <img height="100" src="{{ asset('10.2.0/img/demos/dentist/icons/icon-1.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary mt-1'}" />
                                    </span>
                                    <h4 class="font-weight-semibold mt-3 pt-2 mb-3 text-5-5 text-color-dark">Convenient Location</h4>
                                    <p class="mb-0 text-3-5 font-weight-medium">Nig.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 px-lg-3">
                            <div class="featured-box featured-box-secondary">
                                <div class="box-content">
                                    ...
                                    <p class="mb-0 text-3-5 font-weight-medium">What we Offer.</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row pt-4 pb-4">
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list list-icons font-weight-semibold text-color-dark text-5">
                    ...
                    <li>
                        <i class="icon-envelope icons text-color-tertiary p-relative top-2 me-2"></i> <a href="https://www.okler.net/cdn-cgi/l/email-protection#d7bab6bebb97b3b8bab6beb9f9b4b8ba" class="text-color-dark text-color-hover-tertiary text-decoration-none"><span class="__cf_email__" data-cfemail="d0bdb1b9bc90b4bfbdb1b9befeb3bfbd">[email&#160;protected]</span></a>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
