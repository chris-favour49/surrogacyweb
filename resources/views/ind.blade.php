...
<!-- Mirrored from www.nobleui.com/html/template/demo1-ds/pages/tables/data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 May 2023 19:54:00 GMT -->
<head>
	<meta charset="UTF-8">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="basic-table.html" class="nav-link">Basic Tables</a>
                </li>
                <li class="nav-item">
                  <a href="data-table.html" class="nav-link">Data Table</a>
                </li>
              </ul>
            </div>
          </li>
